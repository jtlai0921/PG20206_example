/*
 * tetromino2.c - 「テトロミノの箱詰め」※回転鏡像解を除く
 *
 * [how to compile]
 ...
 * 右辺と下辺に壁を置く。
   ...
   ■■■■■■
 */
#define WIDTH (5+1)        /* 盤面の横サイズ＋壁 */
#define HEIGHT (8+1)       /* 盤面の縦サイズ＋壁 */
#define POS(x,y) ((x) + (y)*WIDTH)
#define WALL -1

#define BITS_PIECES 4   /* ピースの構成要素数 */
#define PIECES 5       /* ピースの種類 */
